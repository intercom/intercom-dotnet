    ...
    public class ContactsClient : Client
    {
        ...
        public Contact View (Contact contact)
        {
            ...
            if (!String.IsNullOrEmpty (contact.id)) {
                ...
                throw new ArgumentNullException ("you need to provide either 'contact.id', 'contact.user_id' to view a contact.");
            }
        ...
        public Contacts List(String email)
        {
            if (String.IsNullOrEmpty(email)) {
                throw new ArgumentNullException ("'email' argument is null.");
            }
