...
namespace Intercom.Test
{
	...
	public class CompanyClientTest : TestBase
	{
		...
		{
			await companyClient.Create(null);
		}

		[Test()]
		[ExpectedException(typeof(ArgumentException))]
		public async Task Delete_MoreThan100CustomAtt_ThrowException()
		{
		...
		[Test()]
		[ExpectedException(typeof(ArgumentException))]
		public async Task Create_CustomAttInvalidChars_ThrowException()
		{
			Dictionary<string, object> custom_attributes = new Dictionary<string, object>();
		...
		[Test()]
		[ExpectedException(typeof(ArgumentNullException))]
		public async Task Update_WithNull_ThrowException()
		{
			await companyClient.Update(null);
		}
	}
}